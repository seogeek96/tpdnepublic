  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        ...
        <a href="https://this-person-doesnot-exist.com/" className={styles.link}>
          https://this-person-doesnot-exist.com/
        </a>
      ...
      <p>
        ...
        and other sites on the internet. Though, visitors can choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL –{' '}
        <a href="https://policies.google.com/technologies/ads" className={styles.link}>
